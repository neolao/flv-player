...
class TemplateMaxi extends TemplateMaxiBase
{
    ...
    public function TemplateMaxi()
    {
        ...
        // NOTE: ExternalInterface depends on Flash player version 8.
        ...
        ExternalInterface.addCallback("isSeeking", this, isSeeking);
        ExternalInterface.addCallback("isPaused", this, isPaused);
        ExternalInterface.addCallback("getDuration", this, getDuration);
        ExternalInterface.addCallback("playVideo", this, doPlay); // "play" is reserved on IE.
        ExternalInterface.addCallback("pauseVideo", this, doPause);
    ...
    static function main():Void
    {
        ...
        // ES: Added
        ExternalInterface.call("flashVideoReady");
    }
    ...
    private function _sliderEnterFrame()
    {
        ...
        // The maximum
        /* ES: I don't think the loadingBar should affect this at all.
    ...
    public function setCurrentTime(n:Number)
    {
        this.controller.setPosition(n);
    }
    ...
    {
        return this._buffering._visible;
    }
    ...
    public function setVolume(vVolume:Number)
    {
        if (vVolume < 0) { vVolume = 0; }
        if (vVolume > this._volumeMax) { vVolume = this._volumeMax; }
        this._volume = vVolume;
        this.controller.setVolume(vVolume);
        this._updateVolume();
    }
